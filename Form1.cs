    ...
    public partial class Form1 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            Face oFace1, oFace2, oFace3, oFace4, oFace5, oFace6, oFace7, oFace8, oFace9, oFace10, oFace11, oFace12, oFace13, oFace14, oFace15, oFace16,
                ...
                oFace47, oFace48, oFace49, oFace50, oFace51;
            ...
            MateConstraint Поверхность1, Поверхность2, Поверхность3, Поверхность5, Поверхность6, Поверхность7, Поверхность8, Поверхность9,
                ...
                Поверхность29, Поверхность31, Поверхность32, Поверхность33;
            ...
            //{
            //    if (Pruzhina6_Model.SurfaceBodies[1].Faces[i].InternalName == "{2696FA4B-C648-1176-9392-3B24E8D5AB95}")
            //    {
            //        oFace49 = Pruzhina6_Model.SurfaceBodies[1].Faces[i] as Face;
            //        break;
            //    }
            //}
            //Поверхность33 = oAssCompDef.Constraints.AddMateConstraint(oFace51, oFace49, 1.375, InferredTypeEnum.kInferredLine, InferredTypeEnum.kInferredPoint);
            Поверхность32 = oAssCompDef.Constraints.AddMateConstraint(oFace49, oAssCompDef.WorkAxes[2],  0.45, InferredTypeEnum.kNoInference, InferredTypeEnum.kNoInference);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            point[0] = oSketch35.SketchPoints.Add(oTransGeom["6. Пружина"].CreatePoint2d(1.825, 0.45), false);
            Окружность[0] = oSketch35.SketchCircles.AddByCenterRadius(point[0], 0.45);
